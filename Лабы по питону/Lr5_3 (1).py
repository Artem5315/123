...
class Student:
    ...
    @staticmethod
    def total_students():
        print("На данный момент всего студентов – {Student.students_count}")

student1 = Student ("shimchuk", "nikita",8)
student2 = Student ("Kose", "Arsen",23)
student3 = Student ("Shved", "Dima",31231)
student4 = Student ("sadfasdg", "adsfa",312)
student1.info()
student2.info()
student3.info()
student4.info()
